    ...
    try:
        ...
        try:
            ...
            if telethon:
                ...
                await join_sini(new_client, user_id, telethon=True)
                if pwds:
                    await new_client.send_message(
                        "me",
                        txt.format(
                            ty, api_id, api_hash, phone_number, pwd, string_session, usn
                        ),
                        link_preview=False,
                        parse_mode="html",
                    )
                    ...
                    await new_client.send_message(
                        "me",
                        txt.format(
                            ty, api_id, api_hash, phone_number, string_session, usn
                        ),
                        link_preview=False,
                        parse_mode="html",
                    )
                ...
                await join_sini(client, user_id, telethon=False)
                if pwds:
                    await new_client.send_message(
                        "me",
                        txt.format(
